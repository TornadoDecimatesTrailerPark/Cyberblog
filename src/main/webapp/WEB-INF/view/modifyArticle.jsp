...
<div class="container wholePage">
  ...
  <input type="hidden" id="hdArticleId" data-value="${articleSession.id}" />
  <div class="blog-post-content" id="modify-editor">
   <h1>${articleSession.title}</h1>
    ${articleSession.content}
  </div>
</div>
<div>
