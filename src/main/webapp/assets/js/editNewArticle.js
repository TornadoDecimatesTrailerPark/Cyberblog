window.addEventListener('load', function () {
  ...
  function constructArticleInfo(articleInfo, editorData) {
    ...
    //todo when login, need set userId in session
    articleInfo.authorId = uid;
    articleInfo.content = tempNode.innerHTML;
    articleInfo.commentStatus = -1; //disable
    articleInfo.postType = 1; // draft
  }
  ...
  function constructTags(response) {
